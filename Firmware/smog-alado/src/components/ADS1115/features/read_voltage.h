...
float read_voltage_ads1115(int channel)
{
    ...
    //* Debugging prints.
    serialMon.println("[ADS1115] Starting voltage readings...");
    serialMon.println("[ADS1115] Channel 0 voltage: " + String(volts0, 3) + "V");
    serialMon.println("[ADS1115] Channel 1 voltage: " + String(volts1, 3) + "V");
    serialMon.println("[ADS1115] Channel 2 voltage: " + String(volts2, 3) + "V");
    serialMon.println("[ADS1115] Channel 3 voltage: " + String(volts3, 3) + "V");
